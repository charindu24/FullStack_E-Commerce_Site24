...
const Navbar = () => {
  ...
  return (
    <header className="fixed top-0 w-full bg-gray-900 bg-opacity-90 backdrop-blur-md shadow-lg z-40
        ...
        <nav className="flex flex-wrap items-center gap-4">
          ...
          {user && (
            ...
            >
              ...
              text-sm group-hover:bg-emerald-400 transition duration-300 ease-in-out"
              >
                {cart.length}
